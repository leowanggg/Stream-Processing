...
This is the project proposed by Mr.Pennerath, it's the realization of two well known algorithms in the field of stream mining. The first One is a simple algorithm for finding frequent elements in streams, the second one is for estimating entropy.
...
The command is: $ ./generate_stream <number of lines> <number of symbols> <type of distribution> <times> <seed> (<r>)
...
Example: after entering $/generate_stream 10 10 uni 1, you will get a stream with 10 symbols(lines) which generated by the uniform distribution like this:
...
The command is: $stream_processing <name of the algorithm> (<threshold>).
...
1. $ ./generate_stream 10000000 10000000 uni 2 1| ./stream_processing maj 0.1. Execute the first alforithm and find the elements with frequency more than 0.1.

2. $ ./generate_stream 10000000 10000000 uni 1 1| ./stream_processing majB 0.1. Execute the brute-force alforithm for finding the elements with frequency more than 0.1.
 
3. $ ./generate_stream 10000000 10000000 uni 2 1| ./stream_processing ent. Execute the second alforithm and estimate the entropy of the input stream.

4. $ ./generate_stream 10000000 10000000 uni 1 1| ./stream_processing entB. Execute tthe brute-force alforithm for estimating the entropy of the input stream.

PS: You can see the result of this program by reading Project_Silin WANG.pdf